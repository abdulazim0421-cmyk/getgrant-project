...
export interface ApiProgramsCardHeroProgramsCardHero
  extends Struct.CollectionTypeSchema {
  collectionName: 'programs_card_heroes';
  info: {
    displayName: 'ProgramsCardHero';
    pluralName: 'programs-card-heroes';
    singularName: 'programs-card-hero';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::programs-card-hero.programs-card-hero'
    >;
    name: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiProgramsCardProgramsCard
  ...
  attributes: {
    ...
    careerPaths: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSountryPageSountryPage extends Struct.CollectionTypeSchema {
  collectionName: 'sountry_pages';
  info: {
    displayName: '\u0421ountry-page';
    pluralName: 'sountry-pages';
    singularName: 'sountry-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    living_cost_row: Schema.Attribute.Component<
      'shared.living-cost-row',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    university: Schema.Attribute.Component<'shared.university', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visa_type: Schema.Attribute.Component<'shared.visa-type', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiUniversityCardHeroUniversityCardHero
  extends Struct.CollectionTypeSchema {
  collectionName: 'university_card_heroes';
  info: {
    displayName: 'UniversityCardHero';
    pluralName: 'university-card-heroes';
    singularName: 'university-card-hero';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::university-card-hero.university-card-hero'
    >;
...
export interface ApiUniversityCardUniversityCard
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['private', 'public']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::programs-card-hero.programs-card-hero': ApiProgramsCardHeroProgramsCardHero;
      'api::programs-card.programs-card': ApiProgramsCardProgramsCard;
      'api::sountry-page.sountry-page': ApiSountryPageSountryPage;
      'api::university-card-hero.university-card-hero': ApiUniversityCardHeroUniversityCardHero;
