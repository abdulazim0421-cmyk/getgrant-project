            ...
            {isOpen && (
                ...
                >
                    ...
                    >
                        ...
                        {/* ЛЕВАЯ СТОРОНА: ФОРМА */}
                        <div className="w-full md:w-1/2 p-6 sm:p-10 flex flex-col justify-center overflow-y-auto h-full">
                            ...
                            <div className="mb-6">
                                ...
                                <p className="text-xs sm:text-sm text-gray-500 mt-1">
                                    {activeTab === "login"
                                        ? "Войдите в свой аккаунт, чтобы продолжить обучение и пользоваться всеми возможностями GetGrant."
                                        : "Создайте аккаунт, чтобы отслеживать программы поступления и общаться с преподавателями."}
                                </p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                                {activeTab === "register" && (
                                    <div className="flex flex-col gap-1.5">
                                        <label className="text-xs font-bold text-gray-700">Имя</label>
                                        <input
                                            type="text"
                                            name="name"
                                            autoComplete="name"
                                            ...
                                            className="h-11 px-3.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition"
                                        />
                                    </div>
                                )}
                                ...
                                <div className="flex flex-col gap-1.5 relative">
                                    <div className="flex justify-between items-center">
                                        ...
                                        {activeTab === "login" && (
                                            <a href="#" className="text-xs font-semibold text-blue-600 hover:underline">Забыли пароль?</a>
                                        )}
                                    </div>
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full h-11 pl-3.5 pr-10 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-600/20 focus:border-blue-600 transition"
                                        />
                                        <button
                                            type="button"
                            ...
                            <div className="relative flex py-4 items-center">
                                ...
                                <span className="flex-shrink mx-3 text-gray-400 text-[11px] font-medium uppercase tracking-wider">или</span>
                                <div className="flex-grow border-t border-gray-100"></div>
                            </div>

                            {/* Социальные кнопки */}
                            <div className="flex flex-col gap-2.5">
                                <button className="w-full h-11 border border-gray-200 rounded-xl flex items-center justify-center gap-2.5 text-sm font-semibold text-gray-700 hover:bg-gray-50 active:scale-98 transition shadow-sm">
                        ...
                        <div className="hidden md:flex w-1/2 bg-gray-950 relative p-10 flex-col justify-between border-l border-gray-100 overflow-hidden">
                            {/* Направленное изображение студентов */}
                            <div className="absolute inset-0 z-0">
                                <Image
                                    src="/image/image_4554a4.jpg" // Файл из public/image/image_4554a4.jpg
                            ...
                            <div className="relative z-10 text-white mt-auto flex flex-col gap-5">
                                ...
                                <div className="flex flex-col gap-3.5 pt-4 border-t border-white/10">
                                    <div className="flex items-center gap-3">
                                        <span className="p-1.5 rounded-lg bg-white/10 text-white backdrop-blur-md shrink-0">
                                            <GraduationCap size={15} />
                                        </span>
                                        <div className="flex flex-col">
                                            <span className="text-xs font-bold">Подбор программ</span>
                                            <span className="text-[11px] text-gray-300/90">Найдём лучшие программы и университеты под ваш профиль</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <span className="p-1.5 rounded-lg bg-white/10 text-white backdrop-blur-md shrink-0">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-xs font-bold">Поддержка на всех этапах</span>
                                            <span className="text-[11px] text-gray-300/90">Сопровождаем от выбора до зачисления и адаптации</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <span className="p-1.5 rounded-lg bg-white/10 text-white backdrop-blur-md shrink-0">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="text-xs font-bold">Международные возможности</span>
                                            <span className="text-[11px] text-gray-300/90">Обучение в ведущих университетах мира</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
