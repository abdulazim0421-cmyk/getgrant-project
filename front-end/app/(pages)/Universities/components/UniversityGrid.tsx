            ...
            <div className="flex flex-col items-center gap-4 pt-2 pb-6">
                <div className="w-full bg-gray-100 rounded-full h-1">
                    <div
                        ...
                        style={{
                            width: `${Math.round((universities.length / (total || 1)) * 100)}%`,
                        }}
                    />
                </div>
                ...
                <div className="flex items-center gap-4 w-full">
                    ...
                    <div className="flex flex-col items-center gap-3">
                        <p className="text-xs text-gray-400">
                            Показано <span className="font-semibold text-gray-600">{universities.length}</span> из <span className="font-semibold text-gray-600">{total}</span> университетов
                        </p>
