    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-y-[8px]">
                <p className="text-sm font-bold text-[#101828] leading-tight line-clamp-2">
                    {u.name}
                </p>
        ...
        <section className="py-16">
            <div className="container mx-auto px-6 lg:px-12">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <Link
                        href="/Universities"
                        className="px-5 py-2 rounded-[8px] bg-[#1570EF] text-white text-sm font-semibold hover:bg-[#1D4ED8] transition-colors"
                    >
                        Показать все
                    </Link>
                </div>
