// CountryHero.tsx — переводы не нужны, данные приходят из Strapi
...
export default function CountryHero({ bannerImage, name, flagImage, description }: CountryHeroProps) {
    return (
        <section className="relative w-full h-[450px] overflow-hidden mb-16">
            <Image src={bannerImage} alt={name} fill className="w-full h-full object-cover object-center" priority unoptimized />
