    ...
    return (
        <div style={{ width: "305.75px", padding: "20px", borderRadius: "16px", border: "1px solid #EAECF0", background: "#FFF", display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            <div className="flex justify-between items-center w-full px-1">
                <span className="text-[14px] text-[#667085]">{t("online.courses.price")}</span>
                <span className="text-[16px] font-bold text-[#101828]">{course.price}</span>
            </div>
            <button onClick={openModal} className="w-full py-2 rounded-lg bg-[#0047FF] text-white text-xs font-semibold hover:bg-[#0035CC] transition-colors">
...
export default function CoursesSection() {
    ...
    return (
        <section className="mb-14">
            <h2 className="text-2xl font-bold text-[#101828] mb-6">{t("online.courses.title")}</h2>
