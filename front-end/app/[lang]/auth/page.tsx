        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    <motion.div
                        className="relative z-10 w-full max-w-[940px] bg-white rounded-[28px] shadow-2xl flex flex-col md:flex-row min-h-[560px] md:h-[620px] my-auto"
                    ...
                    >
                        ...
                        <div className="hidden md:flex w-1/2 relative p-10 flex-col justify-between overflow-hidden rounded-r-[28px]">
                            <div className="absolute inset-0 z-0">
                                <Image
                                    src="/image/hero-students.jpng"
                                ...
                                <div className="flex flex-col gap-3.5 pt-4 border-t border-white/10">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-[11px] text-gray-300/90">{t("auth.promo.benefit1.desc")}</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <span className="p-1.5 rounded-lg bg-white/10 text-white backdrop-blur-md shrink-0">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-[11px] text-gray-300/90">{t("auth.promo.benefit2.desc")}</span>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-3">
                                        <span className="p-1.5 rounded-lg bg-white/10 text-white backdrop-blur-md shrink-0">
                                        ...
                                        <div className="flex flex-col">
                                            ...
                                            <span className="text-[11px] text-gray-300/90">{t("auth.promo.benefit3.desc")}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
